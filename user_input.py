...
def get_narrator() -> str:
    ...
    while not valid_input:
        third_p_input: str = input("Is the book written in third person? Y/n > ")
    ...
    if is_third:
        ...
        return input("Enter narrator's name as identified by most characters in the story > ")
...
def confirm_inputs(book_dict: dict) -> dict:
    ...
    while True:
        ...
        choice = input("\nIf this is correct, type Y to continue, otherwise, enter the item you wish to change > ").lower()
        ...
        if choice.upper() == "Y":
            ...
            if key_name in key_name_map.keys():
                ...
                print("Invalid key name. Please enter a valid number or key name.")
