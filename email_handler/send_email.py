...
class EmailHandler(EmailManager):
    ...
    def __init__(self) -> None:
        ...
        self.server: str = os.enviorn["MAIL_SERVER"]
        self.port: int = os.environ["MAIL_PORT"]
    ...
    def send_mail(self, user_email: str, attachment: Optional[Tuple[str, str]] = None, error_msg: Optional[bool] = False, ) -> None:
        """
        ...
        subject = "A critical error occured" if error_msg else "Your Binder is ready"
        try:
    ...
    def email_error(self, error_msg: str) -> None:
        ...
        """
        self.send_mail(self.admin_email, error_msg)
