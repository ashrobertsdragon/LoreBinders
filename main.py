...
def main():
  ...
  while not invalid_file:
    file_path = input("Enter the file name of the book (including the .txt extension): ")
  ...
  while not valid_analysis_type:
    ...
    if analysis_type == 1:
      ...
      characteranalysis.analyze_book(file_path)
      valid_analysis_type = True
    elif analysis_type == 2:
      import plotanalysis
      plotanalysis.analyze_book(file_path)
      valid_analysis_type = True
    else:
